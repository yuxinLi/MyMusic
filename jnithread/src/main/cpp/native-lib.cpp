...
Java_com_example_jnithread_ThreadDemo_normalThread(JNIEnv *env, jobject instance) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_jnithread_ThreadDemo_mutexThread(JNIEnv *env, jobject instance) {
...
void *childCallback(void *data){
    JavaListener *jl = (JavaListener *)data;
    jl->onError(0 , 101 , "c++ call java meid from child thread!");
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_jnithread_ThreadDemo_callbackFromC(JNIEnv *env, jobject instance) {
